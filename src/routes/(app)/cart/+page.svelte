...
<main class="mx-auto max-w-7xl flex flex-col gap-2 px-6 py-10 body-secondPlan">
	<div class="w-full rounded-xl p-6 flex flex-col gap-6 body-secondPlan border-gray-300">
