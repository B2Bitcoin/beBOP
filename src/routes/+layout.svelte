		...
		<div class="flex items-center ml-auto gap-2">
			...
			<div class="relative">
				...
				{#if $productAddedToCart}
					<div class="absolute z-10 -bottom-7 -right-2 w-[562px] max-w-[95vw] translate-y-full">
						<ProductAddedToCart
							class="bg-gray-40 drop-shadow-[0_4px_10px_rgba(0,0,0,0.13)] after:absolute after:z-20 after:top-0 after:right-[30px] after:w-0 after:h-0 after:-bottom-1 after:-translate-y-full after:border-l-[10px] after:border-l-transparent after:border-r-[10px] after:border-r-transparent after:border-b-[18px] after:border-b-gray-40"
