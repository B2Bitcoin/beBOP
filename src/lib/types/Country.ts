...
export const countryNameByAlpha2 = {
	AF: 'Afghanistan',
	AL: 'Albania',
	DZ: 'Algeria',
	AS: 'American Samoa',
...
export const COUNTRY_ALPHA2S = typedKeys(countryNameByAlpha2);

export type CountryAlpha2 = keyof typeof countryNameByAlpha2;

export function countryName(alpha2: string) {
	return countryNameByAlpha2[alpha2 as CountryAlpha2] || alpha2;
}
