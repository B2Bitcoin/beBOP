<svg viewBox="0 0 214 63" xmlns="http://www.w3.org/2000/svg" fill="currentColor" {...$$restProps}
	><g fill-rule="evenodd" class="logo-symbol"
		><path
			...
			fill-rule="nonzero"
		></path></g
	><g fill-rule="evenodd" class="logo-text"
		><path
